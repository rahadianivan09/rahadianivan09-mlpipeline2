...
| **Opsi Deployment** | **Docker container** menjalankan **TensorFlow Serving**, di-hosting di **Hugging Face Spaces** (mendukung Docker native, gratis, stabil, alternatif dari Heroku/Railway). |
| **Web App** | [rahadianivan09-bank-deposit-prediction.hf.space](https://rahadianivan09-bank-deposit-prediction.hf.space) |
| **Monitoring** | **Prometheus** men-scrape metrics dari endpoint TF Serving di cloud, disinkronkan ke **Grafana** untuk dashboard visual. Target `tfserving-bank-deposit` terpantau **UP** secara konsisten. |
...
Screenshot bukti: `rahadianivan09-deployment.png`
...
|---|---|---|---|---|---|---|
| 1 | 58 | management | 2143 | 261s | 0.3168 | Tidak Deposit ❌ |
| 2 | 44 | technician | 29 | 151s | 0.2996 | Tidak Deposit ❌ |
| 3 | 33 | entrepreneur | 2956 | 199s | 0.4149 | Tidak Deposit ❌ |
